...
class __TwigTemplate_741e8a460ec78f4a425253bed44acbd532df43b9db12a95a4042a09504d25be1 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/bitnami/wordpress/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_xXGLOiukKN4DVg5Zqvl6PmI/templates/database/export/index.twig");
    }
}

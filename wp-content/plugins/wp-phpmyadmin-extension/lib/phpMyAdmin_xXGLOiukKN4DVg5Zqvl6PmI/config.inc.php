...
$cfg['blowfish_secret']					= '\\9xvi==Bn@4oDe$R?/kK^IbDq#o@}=K@' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_xXGLOiukKN4DVg5Zqvl6PmI/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);

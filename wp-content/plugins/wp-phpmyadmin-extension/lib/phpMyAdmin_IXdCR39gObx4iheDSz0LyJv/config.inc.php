...
$i++;
$cfg['Servers'][$i]['host'] 			= 'wordpress.cgarcyvbantn.ap-southeast-2.rds.amazonaws.com';
$cfg['Servers'][$i]['port'] 			= '';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= 'zId\"\"]KI>!:wd.~/6b.*Jd?@EA>YRC@u' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_IXdCR39gObx4iheDSz0LyJv/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
